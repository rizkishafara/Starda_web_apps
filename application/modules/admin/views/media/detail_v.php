    ...
    <div class="container-fluid bg-white shadow mb-4">
        <div class="p-5 text-center">
            ...
            <div>
                ...
                <div class="row mb-2">
                    <span class="col text-left pl-0">Diunggah oleh : <?= $detail->fullname ?></span>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="col btn btn-success m-3" href="<?= base_url('member/produk/download_document/' . $dok->id_document) ?>">Download</a>
                </div>
            </div>
        </div>
    </div>
